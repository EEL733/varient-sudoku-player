...
pzpr.failcodes = {
	en: {"complete":"Complete!","bkDupNum":"There are equal numbers in a block.","nmDupRow":"There are equal numbers in a row or column.","ceNoNum":"There is an empty cell.","nmSightNe":"The number of visible buildings is wrong.","nmXYNe":"そのマスから見てX番目にYか、Y番目にXがありません。","nmFrameSumNe":"そのマスから見て太線までの数字の和が正しくありません。"},
	ja: {"complete":"正解です！","bkDupNum":"同じブロックに同じ数字が入っています。","nmDupRow":"同じ列に同じ数字が入っています。","ceNoNum":"数字の入っていないマスがあります。","nmSubNe1":"隣り合う数字の差が1になっています。","nmSightNe":"見えるビルの数が正しくありません。","nmXYNe":"そのマスから見てX番目にYか、Y番目にXがありません。","nmFrameSumNe":"そのマスから見て太線までの数字の和が正しくありません。"}
};
